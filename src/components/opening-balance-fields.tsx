    ...
    <div className="grid gap-4">
      ...
      <div className="grid gap-1.5">
        ...
        <p className="text-xs text-muted-foreground">
          Cash you had at the start of this day. Each consignment is treated as
          landing two days later (1 Sept counts as 3 Sept). Those effective dates
          after this day are added; on or before it they are already in this
          number.
        </p>
      </div>
    </div>
